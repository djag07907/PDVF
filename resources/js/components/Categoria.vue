                        ...
                        <div class="modal-body">                            
                            ...
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal" @submit.prevent="onSubmit">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" v-validate.initial="'required|alpha_spaces|min:2|max:50|'" maxlength="55" v-model="nombre" class="form-control" placeholder="Nombre de categoria" name="Nombre">
           ...
           registrarCategoria(){
               ...
               axios.post('/categoria/registrar',{
                 ...
                 'descripcion':this.descripcion
                    ...
                    Swal.fire(
                       '¡Opss!',
                       'Parece que la categoria ya existe',
                       'error'
                    );
                    console.log(error);
                });
