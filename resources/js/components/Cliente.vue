                            ...
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <input type="text" v-if="tipo_documento === 'RTN'" v-validate.initial="{ required: true, regex:/[0|1]{1}[\d]{13}/}" v-model="num_documento" maxlength="15" class="form-control" placeholder="Número de documento" name="Número de documento">
                                        <input type="text" v-if="tipo_documento === 'IDENTIDAD'" v-validate.initial="{ required: true, regex:/[0|1]{1}[\d]{12}/}" v-model="num_documento" maxlength="14" class="form-control" placeholder="Número de documento" name="Número de documento">
